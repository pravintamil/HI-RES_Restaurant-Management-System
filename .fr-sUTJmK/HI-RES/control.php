        	...
        	if(!$con){
            	...
            	if($qr['employee_id']){
            	    ...
            	    elseif($qr['status']==0){
                    	...
                    	$query="SELECT * FROM employee as em JOIN employee_role as er ON em.employee_id=er.employee_id JOIN roles as rol ON er.role_id=rol.role_id WHERE `email` LIKE '$email' AND binary `password` LIKE '$pass'";
