		...
		controller: [ '$scope', function($scope) {
			...
			$scope.loadPDF = function(path) {
				...
				PDFJS.getDocument(path, null, null, $scope.documentProgress).then(function(_pdfDoc) {
					document.getElementById("pdf_err").removeAttribute("style");
					document.getElementById("pdf_err").setAttribute("style","z-index:-1;display:none");
					document.getElementById("pdf_err1").removeAttribute("style");
					document.getElementById("pdf_err1").setAttribute("style","z-index:-1;display:none");
					...
					document.getElementById("pdf_err").removeAttribute("style");
					document.getElementById("pdf_err").setAttribute("style","z-index:5;display:initial");
					document.getElementById("pdf_err1").removeAttribute("style");
					document.getElementById("pdf_err1").setAttribute("style","z-index:5;display:initial");
